...
const styles = StyleSheet.create({
  ...
  formCard: {
    backgroundColor: '#232946', margin: 20, padding: 20, borderRadius: 15,
    shadowColor: '#ff00c8', shadowOpacity: 0.2, shadowRadius: 10, elevation: 5,
  },
  label: { fontSize: 16, fontWeight: '600', color: '#39ff14', marginBottom: 10, textShadowColor: '#ff00c8', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 2 },
  input: {
    backgroundColor: '#232946', borderWidth: 1, borderColor: '#00eaff', borderRadius: 8,
    padding: 15, fontSize: 16, marginBottom: 20, color: '#39ff14', textShadowColor: '#fffb00', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 2,
  },
  photoBtn: { backgroundColor: '#ff00c8', padding: 12, borderRadius: 8, alignItems: 'center', marginBottom: 15, shadowColor: '#ff00c8', shadowOpacity: 0.7, shadowRadius: 8, elevation: 2 },
  photoBtnText: { color: '#39ff14', fontSize: 15, fontWeight: 'bold', textShadowColor: '#fffb00', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 2 },
  previewImage: { width: '100%', height: 200, borderRadius: 10, marginBottom: 15, resizeMode: 'cover' },
  saveBtn: { backgroundColor: '#39ff14', padding: 15, borderRadius: 8, alignItems: 'center', shadowColor: '#39ff14', shadowOpacity: 0.7, shadowRadius: 8, elevation: 2 },
  saveBtnText: { color: '#18181b', fontSize: 16, fontWeight: 'bold', textShadowColor: '#fffb00', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 4 },
  historySection: { paddingHorizontal: 20, paddingBottom: 40 },
  historyTitle: { fontSize: 20, fontWeight: 'bold', color: '#ff00c8', marginBottom: 15, textShadowColor: '#fffb00', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 4 },
  historyRow: { flexDirection: 'row', backgroundColor: '#232946', padding: 15, borderRadius: 10, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: '#39ff14' },
  historyContent: { flex: 1, marginLeft: 10 },
  historyDate: { fontSize: 14, color: '#00eaff', marginBottom: 5, textShadowColor: '#ff00c8', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 2 },
  historyWeight: { fontSize: 22, fontWeight: 'bold', color: '#39ff14', textShadowColor: '#fffb00', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 4 },
  historyNotes: { fontSize: 14, fontStyle: 'italic', color: '#fffb00', marginTop: 5, textShadowColor: '#00eaff', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 2 },
